...
function HelpScreen(options) {
     ...
     * @default undefined
     */
    this.preDisplayHook = defaultValue(options.preDisplayHook, undefined);
     ...
     * @default undefined
     */
    this.postDisplayHook = defaultValue(options.postDisplayHook, undefined);
    ...
    this.widthOverride = defaultValue(options.widthOverride, 300);
